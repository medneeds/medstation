                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20 rounded-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-bold text-sm text-foreground mb-1">Garantia incondicional de 7 dias</h4>
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Teste sem riscos. Se não ficar satisfeito, devolvemos 100% do seu dinheiro. Sem perguntas, sem burocracia.
                      </p>
                    </div>
                  </div>
                </div>
